...
public final class TopicDescriptors {
     ...
     * KafkaTopicInput}? Get one of those by calling {@link
     * OwnedKafkaTopicOutput#toInput()} on the topic descriptor
     ...
     *
     * <p>Looking for a version that returns {@link
     * KafkaTopicOutput}? Get one of those by calling {@link
