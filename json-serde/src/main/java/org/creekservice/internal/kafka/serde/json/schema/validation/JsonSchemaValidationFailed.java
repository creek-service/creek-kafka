...
public final class JsonSchemaValidationFailed extends SchemaException {

    JsonSchemaValidationFailed(final String topic, final Part part, final Throwable cause) {
