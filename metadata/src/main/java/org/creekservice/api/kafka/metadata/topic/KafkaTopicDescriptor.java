...
public interface KafkaTopicDescriptor<K, V> extends ResourceDescriptor {
    ...
    /** The schema name to use in resource URIs for Kafka topics. */
    ...
    interface PartDescriptor<T> extends ResourceCollection {
        ...
        enum Part {
            /** The key part of a Kafka record. */
            key,
            /** The value part of a Kafka record. */
            value;
        ...
        /**
         * @return the name of the part this descriptor describes.
         */
        Part name();
        ...
        /**
         * @return resources associated with this part. For example, a schema resource.
         */
